  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "http://localhost:5000/authentication/userRegister",
        {
          method: "POST",
      ...
      if (res.ok) {
        setDialog({
            ...
            message: data.message || "User Registration successful! Waiting for admin's approval.",
            isError: false
        });
    ...
    <>
      ...
      <div className="register-container">
        <div className="register-card">
          <h2 className="register-heading">Create User Account</h2>
